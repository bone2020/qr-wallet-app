...
class _BiometricWidgetState extends State<BiometricWidget> {
  ...
  void initState() {
    ...
    _model.fullNameFieldBIOTextController ??= TextEditingController();
    ...
    _model.nextOfKingTextController ??= TextEditingController();
    _model.nextOfKingFocusNode ??= FocusNode();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.nextOfKingTextController,
                              focusNode: _model.nextOfKingFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                isDense: true,
                              ...
                              cursorColor:
                                  FlutterFlowTheme.of(context).primaryText,
                              validator: _model
                                  .nextOfKingTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            onChanged: (val) async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                        .isDataUploading_biometricIDFrontAppState1 =
                                    true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_biometricIDFrontAppState1 =
                                      false;
                                }
                                if (selectedUploadedFiles.length ==
                                    selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_biometricIDFrontAppState1 =
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_biometricIDFrontFirebase =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_biometricIDFrontFirebase =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_biometricIDFrontFirebase =
                                                    selectedUploadedFiles.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_biometricIDBackFirebase =
                                                true);
                                            var selectedUploadedFiles =
                                                <FFUploadedFile>[];
                                            ...
                                            try {
                                              ...
                                              ScaffoldMessenger.of(context)
                                                  .hideCurrentSnackBar();
                                              _model.isDataUploading_biometricIDBackFirebase =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_biometricIDBackFirebase =
                                                    selectedUploadedFiles.first;
                                              });
                                              showUploadMessage(
                                                  context, 'Success!');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            {
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataBio = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              var selectedMedia = <SelectedFile>[];
                              var downloadUrls = <String>[];
                              try {
                                selectedUploadedFiles = _model
                                        .uploadedLocalFile_biometricIDBackFirebase
                                        .bytes!
                                        .isNotEmpty
                                    ? [
                                        _model
                                ...
                                _model.isDataUploading_uploadDataBio = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataBio =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDataBio =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await currentUserReference!
                              ...
                              idFrontUrl: _model
                                  .uploadedLocalFile_biometricIDFrontAppState1
                                  .width
                                  ?.toString(),
                              idBackUrl: _model
                                  .uploadedLocalFile_biometricIDFrontFirebase
                                  .width
                                  ?.toString(),
                              nextOfKin: _model.nextOfKingTextController.text,
                              displayName:
                            ...
                            {
                              safeSetState(() => _model
                                  .isDataUploading_biometricIDfront = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              var selectedMedia = <SelectedFile>[];
                              var downloadUrls = <String>[];
                              try {
                                ...
                                _model.isDataUploading_biometricIDfront = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_biometricIDfront =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_biometricIDfront =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
