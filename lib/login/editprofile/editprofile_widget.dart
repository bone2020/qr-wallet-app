...
class _EditprofileWidgetState extends State<EditprofileWidget> {
  ...
  void initState() {
    ...
    _model.profileUserNameTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.userName, ''),
      'User Name ',
    ));
    _model.profileUserNameFocusNode ??= FocusNode();
                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: Image.memory(
                              _model.uploadedLocalFile_profilePicAppstate
                                      .bytes ??
                                  Uint8List.fromList([]),
                              fit: BoxFit.cover,
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData7w3 = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData7w3 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadData7w3 =
                                  ...
                                  if (selectedMedia != null &&
                                      selectedMedia.every((m) =>
                                          validateFileFormat(
                                              m.storagePath, context))) {
                                    safeSetState(() => _model
                                            .isDataUploading_profilePicAppstate =
                                        true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_profilePicAppstate =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                            ...
                            children: [
                              AuthUserStreamWidget(
                                builder: (context) => TextFormField(
                                  controller:
                                      _model.profileUserNameTextController,
                                  focusNode: _model.profileUserNameFocusNode,
                                  autofocus: false,
                                      ...
                                      if (selectedMedia != null &&
                                          selectedMedia.every((m) =>
                                              validateFileFormat(
                                                  m.storagePath, context))) {
                                        safeSetState(() =>
                                            _model.isDataUploading_companyLogo =
                                                true);
                                        var selectedUploadedFiles =
                                            <FFUploadedFile>[];
                                        ...
                                        if (selectedUploadedFiles.length ==
                                            selectedMedia.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_companyLogo =
                                                selectedUploadedFiles.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await currentUserReference!.update(createUsersRecordData(
                      ...
                      userName: _model.profileUserNameTextController.text,
                      phoneNumber: _model.phoneNumberTextController.text,
                      isCompany: _model.switchValue,
                      companyName: _model.brandNameTextController.text,
                      companyMessage: _model.messageTextController.text,
                    ));
